...
public class GrappleScript : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (FigmentInput.GetButtonUp(FigmentInput.FigmentButton.ActionButton)) //checks if the action button is released
        {
        ...
        {
            if (FigmentInput.GetButtonDown(FigmentInput.FigmentButton.ActionButton)) //checks if the action button is pressed down
            {
            ...
            if (FigmentInput.GetButton(FigmentInput.FigmentButton.LeftButton) && FigmentInput.GetButton(FigmentInput.FigmentButton.RightButton)) //checks if both left and right are pressed
            {
                GrowRope();
            }
            else if (FigmentInput.GetButton(FigmentInput.FigmentButton.LeftButton)) //checks if the left button is pressed
            {
            ...
            else if (FigmentInput.GetButton(FigmentInput.FigmentButton.RightButton)) //checks if the right button is pressed
            {
